...
CN.printFactors();*/
    ...
    static void task2()
    {
        /*Console.WriteLine(CryptoUtils.jakobi(219, 383));*/
        for (BigInteger i = BigInteger.Pow(10, 60); i < BigInteger.Pow(10, 80); i++)
        {
            if (CryptoUtils.AllTest(i))
            {
                Console.WriteLine($"{i} is a prime!");
               
            }
            if (i % 1000000 == 0) Console.WriteLine("done\t" + i);
        }
    }
